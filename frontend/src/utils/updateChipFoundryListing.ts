...
export const updateChipFoundryListing = async () => {
  ...
  const updateData: any = {
    company_name: 'Efabless Corporation',
    company_website: 'https://www.chipfoundry.io',
...
Now in Assignment for Benefit of Creditors (ABC) as of April 7, 2025, following an unsuccessful Series B financing, this represents a strategic acquisition of proven technology, a large engaged community, and comprehensive IP assets positioned at the intersection of open-source innovation and commercial semiconductor development.`,
    ...
    highlights: [
      '100x cost reduction vs traditional ASICs through open-source EDA, IP revenue-sharing, and MPW aggregation',
      '10x lower power consumption vs MCUs/FPGAs/CPUs for edge applications',
      'Expands designer pool from 200K chip experts to 20M+ software/hardware engineers',
      'Pre-built SoC platforms eliminate 3-6 month licensing delays',
      '13,000+ registered designers from 50+ countries',
      '40+ product companies across 9 countries using the platform',
      '50+ academic institutions using chipIgnite program',
      'Global custom silicon market exceeds $20B, edge AI market at $16B with 33.9% CAGR',
      '15 issued patents (3 pending) covering essential chip design elements',
      'Silicon-validated ML accelerator and next-gen Caravel platforms'
    ],

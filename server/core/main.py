...
class ScopeDocGenerator:
    ...
    def generate(
        ...
        # Research augmentation (disabled)
        try:
            mode = ResearchMode(research_mode)
        except ValueError:
            print(f"[WARN] Unknown research mode '{research_mode}', defaulting to 'none'")
...
def main():
    ...
    parser.add_argument(
        ...
        default=ResearchMode.NONE.value,
        help="Research is disabled; this flag remains for backwards compatibility.",
    )

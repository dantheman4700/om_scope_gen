...
const ListingSettings = () => {
  ...
  const fetchListingSettings = async () => {
    ...
    try {
      ...
      setEmailAutomationEnabled(listing.email_automation_enabled || false);
      // Handle email_domain_preference if it exists in meta
      const meta = listing.meta as Record<string, any> | null;
      if (meta?.email_automation) {
        const automation = meta.email_automation;
      ...
      // For now, use mock email sequences
      setEmailSequences([
        { id: "seq-1", name: "Default Outreach", steps: [] },
        { id: "seq-2", name: "Follow-up Sequence", steps: [] },
      ]);
    } catch (error: any) {
  ...
  const handleSave = async () => {
    ...
    try {
      await listingsApi.update(id, {
          meta: {
            email_automation: {
            enabled: emailAutomationEnabled,
        ...
        <Tabs defaultValue="automation" className="w-full">
          ...
          <TabsContent value="automation" className="space-y-6 mt-6">
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={emailAutomationEnabled} onCheckedChange={setEmailAutomationEnabled} />
                </div>
              </CardHeader>
            </Card>
              ...
              <>
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {selectedSequence && sequenceSteps.length > 0 && <SequencePreview steps={sequenceSteps} />}
            ...
            <div className="flex gap-4">
              ...
              <Button variant="outline" onClick={() => navigate(`/dashboard/listing/${id}`)}>
                Cancel
              </Button>
            </div>
          </TabsContent>
